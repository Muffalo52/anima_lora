...
| [spd.md](spd.md) | Spectral Progressive Diffusion — early steps at low res, spectral noise-expansion handoff to full res. Runner in `networks/spd.py`. | `--spd` | v0 = Euler-only, no SMC/Spectrum compose; single-late `0.5→1.0 @ σ0.7` default. `bench/spd/plan.md` Phase 3, `../proposal/spd_finetune_lora.md` (Case B). |
