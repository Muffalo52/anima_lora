...
`results/20260726-2109/`; same command re-runs) in favor of the
...
Outcome (`results/20260727-1421/`, full read in `bench/report.md`):
...
Outcome (`results/20260727-1639/`, full read in `bench/report.md`
...
Outcome (`results/20260815-1041-yarn768/`, full read in
