...
Usage::
    ...
    uv run python project/sigma_lowres/bench/traj_stats/run_reuse_oracle.py \
        --traces project/sigma_lowres/bench/traj_stats/results/20260723-2100-phase1/traces_gen \
...
def main() -> None:
    ...
    ap.add_argument(
        "--traces",
        default="project/sigma_lowres/bench/traj_stats/results/20260723-2100-phase1/traces_gen",
