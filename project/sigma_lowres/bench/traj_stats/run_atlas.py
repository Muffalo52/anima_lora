...
Usage::
    ...
    uv run python project/sigma_lowres/bench/traj_stats/run_atlas.py --smoke --label smoke
    uv run python project/sigma_lowres/bench/traj_stats/run_atlas.py --arms static --label static-only
"""
