...
Usage::
    ...
    uv run python project/sigma_lowres/bench/traj_stats/run_bench.py --label phase0
    uv run python project/sigma_lowres/bench/traj_stats/run_bench.py --with_spectrum --label phase0-spec
    uv run python project/sigma_lowres/bench/traj_stats/run_bench.py --size 512 512 --steps 12  # smoke
"""
