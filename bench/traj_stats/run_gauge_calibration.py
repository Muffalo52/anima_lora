...
Usage::
    ...
    uv run python bench/traj_stats/run_gauge_calibration.py --smoke --label smoke
"""
...
from bench.traj_stats.gauge import gauge  # noqa: E402
from bench.traj_stats.run_atlas import DIT, TEXT_ENCODER, VAE, pick_prompts  # noqa: E402
