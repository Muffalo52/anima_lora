...
Usage::
    ...
    uv run python bench/traj_stats/analyze_subspace.py --out subspace.json
"""
...
DEFAULT_TOK_TRACES = "bench/traj_stats/results/20260723-2120-phase2/traces_baseline"
DEFAULT_GEN_TRACES = "bench/traj_stats/results/20260723-2100-phase1/traces_gen"
