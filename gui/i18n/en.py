...
STRINGS: dict[str, str] = {
    ...
    # Soup pipeline tab (gui/tabs/soup_tab.py)
    "soup_target": "Target artist",
    "soup_target_tip": "Artist directory under post_image_dataset/resized/ whose LoRA you want to soup. Required.",
    "soup_pool": "Pool (optional)",
    "soup_pool_tip": "Space-separated artist names for the uncond inter-train pool. Blank = the shard that already contains the target.",
    "soup_pool_shard_n": "Pool shard size",
    "soup_pool_shard_n_tip": "How many artists share one uncond-init checkpoint (default 16).",
    "soup_uncond_ratio": "Uncond ratio",
    "soup_uncond_ratio_tip": "caption_dropout_rate for the uncond inter-train phase (default 0.5).",
    "soup_uncond_epochs": "Uncond epochs",
    "soup_uncond_epochs_tip": "Epochs for the uncond inter-train phase (default 2).",
    "soup_seeds": "Seeds",
    "soup_seeds_tip": "Space-separated seeds; one fine-tune per seed, then souped (default 1001 1002 1003).",
    "soup_rank": "SVD rank",
    "soup_rank_tip": "Rank the soup ΔW is SVD-truncated to. 0 = use the method's network_dim.",
    ...
    "soup_target_required": "Soup needs a target artist (a directory under post_image_dataset/resized/).",
    "n_images": "{n} images",
    # ImageViewerTab
    "directory": "Directory:",
